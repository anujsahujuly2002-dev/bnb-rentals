                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <td style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">
                            ...
                            <td class="grid__col" style="font-family: 'Helvetica neue', Helvetica, arial, sans-serif; padding: 32px 40px; ">
                                ...
                                <p style="color: #666666; font-weight: 400; font-size: 15px; line-height: 21px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif; " class="">Hi {{$name}},</p>
                                <p style="color: #666666; font-weight: 400; font-size: 15px; line-height: 21px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif; " class="">We're sending you this email because you requested a password reset. Click on this link to create a new password.</p>
                                <p style="text-align: center;"><a href="{{route('admin.reset.password.get',$token)}}" style="background: #1e1d85;padding: 18px 40px;color: #fff;text-decoration: none;font-weight: normal;font-size: 20px;display: inline-block;border-radius: 50px;margin: 20px auto;">Set a new password</a></p>
                                
                                <p style="color: #666666; font-weight: 400; font-size: 15px; line-height: 21px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif; " class="">If you didn't request a password reset, you can ignore this email. Your password will not be changed.</p>
                                <hr>
