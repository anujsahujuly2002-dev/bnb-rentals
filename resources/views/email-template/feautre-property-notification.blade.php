                                        ...
                                        <tr>
                                            <td>
                                                <table cellpadding="0" cellpadding="0" border="0" width="100%" class="col" style="margin-top: 20px;font-family: 'Open Sans', sans-serif;font-size: 14px;">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                        <td align="center" style="padding: 10px; background: #eeeeee;">${{env('FEATURED_PROPERTY_PRICE')}}</td>
                                                        <td align="center" style="padding: 10px; background: #eeeeee;">{{count(explode(",",$content->property_id))}}</td>
                                                        <td align="center" style="padding: 10px; background: #eeeeee;">{{$content->month}} Month</td>
                                                        <td align="center" style="padding: 10px; background: #eeeeee;">${{$content->amount}}/-</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
