                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <a class="text-center" href="javascript:void();"> <h4>BNB Rental Pasword Reset</h4></a>
                                <form class="mt-5 mb-5 login-input" id="passwordReset">
                                    ...
                                    <button class="btn login-form__btn submit w-100"  type="submit">Reset Password</button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    ***********************************-->
    ...
    <script>
       $("#passwordReset").on("submit",function(e){
            ...
            let formData = new FormData($("#passwordReset")[0]);
            $.ajax({
                type: 'POST',
                ...
                success:function(res){
                    ...
                    if(xhr.status===500){
                        ...
                        $(".error-email").text(error.password);
                        $(".error-password").text(error.confirm_password);
                        $(".buttonload").addClass("d-none");
                        $(".buttonload").removeClass("disabled");
                        $(".login-form__btn").removeClass("d-none");
                    }
