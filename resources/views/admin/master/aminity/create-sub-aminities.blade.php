        ...
        <div class="content-body">
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    ...
                    <div class="row">
                        <div class="col-md-6"><h4 style="color:black">Create Sub Aminities</h4></div>
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" method="post" action="{{ route('admin.master.store.sub.aminities') }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="name" placeholder="Enter a aminites.." value="{{ old('sub_aminity_name') }}">
                                                @error('name')
                                                 <span class="text-danger">{{ $message }}</span>   
                                                @enderror
                                            </div>
