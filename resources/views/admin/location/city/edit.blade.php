        ...
        <div class="content-body">
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    ...
                    <div class="row">
                        <div class="col-md-6"><h4 style="color:black">Edit City</h4></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" method="post" action="{{ route('admin.location.city.update') }}">
                                        @csrf
                                                ...
                                                <select class="form-control" name="country_name" id="country_name" style="width: 100%;">
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option value="{{ $country->id }}" 
                                                            @if($country->id == $city->country_id) selected @endif>{{ $country->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('country_name')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" name="state_name" id="state_name" data-id="{{ $city->state_id }}">
                                                    <option value="">Select State</option>
                                                    @foreach ($states as $state)
                                                        <option value="{{ $state->id }}" 
                                                            @if($state->id == $city->state_id) selected @endif>{{ $state->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('state_name')
                                                 <span class="text-danger">{{ $message }}</span>   
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" name="region_name" id="region_name">
                                                    ...
                                                    <option value="{{ $region->id }}" 
                                                        @if($region->id == $city->region_id) selected @endif>{{ $region->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('region_name')
                                                 <span class="text-danger">{{ $message }}</span>   
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">City Name <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="name" placeholder="Enter a State.." value="{{ old('name')??$city->name }}">
                                                @error('name')
                                                 <span class="text-danger">{{ $message }}</span>   
                                                @enderror
                                            </div>
