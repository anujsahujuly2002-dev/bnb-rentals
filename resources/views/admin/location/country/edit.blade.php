        ...
        <div class="content-body">
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    ...
                    <div class="row">
                        <div class="col-md-6"><h4 style="color:black">Edit Country</h4></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" method="post" action="{{ route('admin.location.country.update') }}">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="name" placeholder="Enter a country.." value="{{ old('name')??$country->name }}">
                                                @error('name')
