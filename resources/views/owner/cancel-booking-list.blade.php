    ...
    <script>
        $(function () {
            var table = $("#your-booking").DataTable({
                ...
                scrollX: true,
                ajax:{
                    url:"{{route('owner.cancel.booking')}}",
                },
                dataType: 'html',
                columns: [
                    {data: 'DT_RowIndex' ,name:'DT_RowIndex',searchable: false,orderable: false},
                    {data: 'traveller_name' ,name:'traveller_name',searchable: false,orderable: false},
                    {data: 'booking_information.property_id' ,name:'booking_information.property_id',searchable: false,orderable: false},
